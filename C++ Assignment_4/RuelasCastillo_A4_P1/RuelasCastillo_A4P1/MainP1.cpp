// ISAAC RUELAS CASTILLO ASSIGNMENT 4 PROBLEM 1
...
void init()
{
	...
	shapes[3] = new ColorCircle(50);			// MultiColorCircle with radius = 50
	shapes[4] = new ColorCircle(100);			// MultiColorCircl with radius = 100
}
